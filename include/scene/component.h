...
namespace Sgl
{
    ...
    public:
        ...
        virtual int32_t computePrefWidth(int32_t height = -1) = 0;
        virtual int32_t computePrefHeight(int32_t width = -1) = 0;
        
        virtual int32_t computeMinWidth(int32_t height = -1) = 0;
        virtual int32_t computeMinHeight(int32_t width = -1) = 0;

        virtual int32_t computeMaxWidth(int32_t height = -1) = 0;
        virtual int32_t computeMaxHeight(int32_t width = -1) = 0;
